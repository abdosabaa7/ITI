...
{
        AccomodationPackageService accomodationPackagesService = new AccomodationPackageService();
        ...
        public ActionResult Index(string searchTerm, int? accomodationPackageID, int? page)
        {
            ...
            model.AccomodationPackages = accomodationPackagesService.GetAccomodationPackages();
